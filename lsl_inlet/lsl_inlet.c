...
/* int lsl_outlet_parse_creation_args(t_lsl_inlet *x, int argc, t_atom *argv){ */
...
/*     else if(!strcmp(arg1->s_name, "-max_len")) */
/*       {	 */
/*   	x->max_len = (int)atom_getfloatarg(1, argc, argv); */
/*   	argc-=2, argv+=2; */
/*       } */
	
/*     else if(!strcmp(arg1->s_name, "-max_hist")) */
/*       { */
/*   	x->max_hist = (int)atom_getfloatarg(1, argc, argv); */
/*   	argc-=2, argv+=2; */
/*       } */

/*     else if(!strcmp(arg1->s_name, "-max_buflen")) */
/*       { */
/*   	x->max_hist = (int)atom_getfloatarg(1, argc, argv); */
/*   	argc-=2, argv+=2; */
/*       } */
...
/*     else{ */
/*       pd_error(x, "lsl_inlet: %s: uniknown flag or argument missint", arg1->s_name); */
/*       argc--; */
/*       argv++; */
/*     } */
/*   } */
...
/* } */
  ...
  /*   if(!strcmp(arg->s_name, "-name")) */
  /*     { */
  /* 	resolved_count = lsl_resove_byprop(x->lsl_info_list, 50, "name", atom_getsymbolarg(1,argc,argv),0,5); */
  /* 	argc-=2, argv+=2; */
  /*     } */
  /*   else if(!strcmp(arg->s_name, "-type")) */
  /*     { */
  /* 	resolved_count = lsl_resove_byprop(x->lsl_info_list, 50, "type", atom_getsymbolarg(1,argc,argv),0,5); */
  /* 	argc-=2, argv+=2; */
  /*     } */
  /*   else if(!strcmp(arg->s_name, "-source_id")) */
  /*     { */
  /* 	resolved_count = lsl_resove_byprop(x->lsl_info_list, 50, "source_id", atom_getsymbolarg(1,argc,argv),0,5); */
  /* 	argc-=2, argv+=2; */
  /*     } */
  /*   else{ */
  /*     pd_error(x, "lsl_inlet: %s: uniknown flag or argument missing", arg->s_name); */
