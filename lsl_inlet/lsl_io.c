...
int lsl_inlet_parse_creation_args(t_lsl_inlet *x, int argc, t_atom *argv){
  ...
  /* stream_name = (char *)malloc(sizeof(char)*100); */
  /* stream_type = (char *)malloc(sizeof(char)*100); */
  /* stream_format = (char *)malloc(sizeof(char)*100); */
  /* source_id = (char *)malloc(sizeof(char)*100); */
